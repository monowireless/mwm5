...
uint8 TWE_CRC8_u8CalcU32(uint32 u32c) {
	uint8 u8buff[4], * q = u8buff;
	TWE_S_OCTET(q, (u32c >> 24) & 0xff);
	TWE_S_OCTET(q, (u32c >> 16) & 0xff);
	TWE_S_OCTET(q, (u32c >> 8) & 0xff);
	TWE_S_OCTET(q, (u32c >> 0) & 0xff);
	return TWE_CRC8_u8Calc(u8buff, 4);
}
