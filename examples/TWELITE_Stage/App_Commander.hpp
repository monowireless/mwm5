...
class App_Commander : public TWE::APP_DEF, public TWE::APP_DESC<App_Commander>, public TWE::APP_HNDLR<App_Commander> {
private:
	// Serial Parser
...
public:
	App_Commander()
		: APP_DEF(int(E_APP_ID::COMMANDER))
		, parse_ascii(256)
		...
		, the_screen(56, 16, { 0,  40, 640, 300 }, M5)
...
public:
	...
	void hndr_SCR_NOTICE1(event_type ev, arg_type arg);

	struct SCR_TWELITE80;
	friend struct SCR_TWELITE80;
	void hndr_SCR_TWELITE80(event_type ev, arg_type arg);
};